...
import com.ifmg.projeto_impressora.controller.AutenticadorController;
import com.ifmg.projeto_impressora.controller.FaturaController;
...
//        this.setVisible(false);
        ...
        try {
            ...
            if (tipo == 'c') {
                FrTecnico frTecnico = new FrTecnico();
                frTecnico.setVisible(true);
                this.setVisible(false);;
            }

            if (tipo == 'v') {
                FrLtdCons frLtd = new FrLtdCons(this);
                frLtd.setVisible(true);
                this.setVisible(false);
            }
